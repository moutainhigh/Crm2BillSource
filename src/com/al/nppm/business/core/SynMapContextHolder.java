...
//            map.get("prodInstAttrId").toString();
        ...
        if(objMap!=null){
            ...
            /*
            userInfoOplogMapper.insertUserInfoOplog005(userInfoOplogMap);
            userInfoOplogMapper.insertUserInfoOplog006(userInfoOplogMap);
            userInfoOplogMapper.insertUserInfoOplog007(userInfoOplogMap);*/
        }
